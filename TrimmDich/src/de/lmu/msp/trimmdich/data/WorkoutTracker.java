 ...
 * 
 */
public class WorkoutTracker implements GooglePlayServicesClient.ConnectionCallbacks,
GooglePlayServicesClient.OnConnectionFailedListener, LocationListener {
	...
	public void setCurrentActivity(Activity activity) {
		...
		// If it's the first time registering check if play services are available
		...
		if(activity == null) {
			...
			locationClient = new LocationClient(currentActivity.getApplicationContext(), this, this);
	...
	private boolean testIfPlayServicesConnected() throws Exception {
        ...
        int resultCode =
                GooglePlayServicesUtil.
                        isGooglePlayServicesAvailable(currentActivity.getApplicationContext());
...
//        	   }
	...
	public void onLocationChanged(Location location) {
		...
		if(currentActivity != null && currentActivity instanceof LocationListener) {
